...
const Products = () => {
  ...
  const category = searchParams.get('category') || 'ROAD SAFETY';
  const [products, setProducts] = useState([]);
  const [filteredProducts, setFilteredProducts] = useState([]);
  const [subcategories, setSubcategories] = useState([]);
  const [selectedSubcategory, setSelectedSubcategory] = useState('ROAD SAFETY');
  ...
  const filterAndSortProducts = () => {
    ...
    if (selectedSubcategory !== 'ROAD SAFETY') {
