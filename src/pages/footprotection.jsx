...
const Products = () => {
  ...
  const category = searchParams.get('category') || 'FOOT PROTECTION';
  const [products, setProducts] = useState([]);
  const [filteredProducts, setFilteredProducts] = useState([]);
  const [subcategories, setSubcategories] = useState([]);
  const [selectedSubcategory, setSelectedSubcategory] = useState('FOOT PROTECTION');
  ...
  const filterAndSortProducts = () => {
    ...
    if (selectedSubcategory !== 'FOOT PROTECTION') {
        ...
        {subcategories.length > 0 && (
          <div className="mb-8">
            <div className="flex flex-wrap gap-4">
              <button
                onClick={() => setSelectedSubcategory('FOOT PROTECTION')}
                className={`px-4 py-2 rounded ${selectedSubcategory === 'FOOT PROTECTION' ? 'bg-blue-600 text-white' : 'bg-gray-200 text-gray-700'}`}
              >
                FOOT PROTECTION
              </button>
