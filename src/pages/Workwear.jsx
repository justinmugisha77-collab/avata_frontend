...
const Products = () => {
  ...
  const [searchParams] = useSearchParams();  const navigate = useNavigate();  const category = searchParams.get('category') || 'all';
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        {/* Title */}
        <h1 className="text-3xl font-bold mb-8">{category.toUpperCase()}</h1>
          ...
          <div className="mb-8">
            <div className="flex flex-wrap gap-4">
              <button
                ...
                className={`px-4 py-2 rounded ${selectedSubcategory === 'all' ? 'bg-blue-600 text-white' : 'bg-gray-200 text-gray-700'}`}
              >
                All
              </button>
